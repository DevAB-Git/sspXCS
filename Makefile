...
$(OUTPUTFILE):	 xcsharness.o xcssystem.o xcsclassifierharness.o xcsconfig.o xcsenvironment.o xcstime.o xcsdefs.o
	$(CC) $(CC_OPTS) -o $(OUTPUTFILE).out $(LINKMATH) xcsharness.o xcssystem.o xcsclassifierharness.o xcsconfig.o xcsenvironment.o xcstime.o xcsdefs.o
