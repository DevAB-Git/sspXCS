...
envConfig::envConfig()
{
    ...
    m_nCondLen = 11;
    m_nRlvntBits = 9;
    m_nMaxPopSize = 0.5*1000;
    m_nMaxProblems = 0.5*100*1000;
    m_nMaxPayoff = 1000;
    m_nActions = 2;
    m_eEnv = multiplexer;
}
...
LogExec::LogExec()
{
    m_strLogPath ="output/sspXCS/";
    m_strPerformance = m_strLogPath+"performance.txt";
    m_strCndnsdClsPop = m_strLogPath+"rulescondensed.txt";
    m_strSmplClsPop = m_strLogPath+"rulesimplified.txt";
    m_strWholeClsPop = m_strLogPath+"ruleswhole.txt";
    m_pfPerformance = NULL;
    m_pfCndnsdClsPop = NULL;
    m_pfSmplClsPop = NULL;
    m_pfWholeClsPop = NULL;
    m_nTotalRuns = 30;
    m_nTestFrequency = 1000;
}
    ...
    if(configFile.is_open())
    {
      while(!readLine(configFile, strLine))
      {
          ...
          else if( strLine.find( "LogPath " ) != string::npos )
          {
              ...
              m_stGLogExec.m_strPerformance = m_stGLogExec.m_strLogPath+"performance.txt";
              m_stGLogExec.m_strCndnsdClsPop = m_stGLogExec.m_strLogPath+"rulescondensed.txt";
              m_stGLogExec.m_strSmplClsPop = m_stGLogExec.m_strLogPath+"rulesimplified.txt";
              m_stGLogExec.m_strWholeClsPop = m_stGLogExec.m_strLogPath+"ruleswhole.txt";
          }
